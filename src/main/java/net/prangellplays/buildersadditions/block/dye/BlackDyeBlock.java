...
public class BlackDyeBlock extends Block {
    public BlackDyeBlock(Settings settings) {
        super(settings);
    }
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        world.addParticle(BuildersAdditionsClient.DRIPPING_BLACK_DYE, (double) pos.getX() + d, (double) pos.getY() + e, (double) pos.getZ() + f, 0.0, 0.0, 0.0);
    }

    @Override
    public boolean hasRandomTicks(BlockState state) {
        return state.getBlock() == BuildersAdditionsBlocks.BLACK_DYE_BLOCK;
    }
}
