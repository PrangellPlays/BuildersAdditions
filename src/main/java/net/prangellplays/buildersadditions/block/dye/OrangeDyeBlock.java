...
public class OrangeDyeBlock extends Block {
    public OrangeDyeBlock(Settings settings) {
        super(settings);
    }
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        world.addParticle(BuildersAdditionsClient.DRIPPING_ORANGE_DYE, (double) pos.getX() + d, (double) pos.getY() + e, (double) pos.getZ() + f, 0.0, 0.0, 0.0);
    }

    @Override
    public boolean hasRandomTicks(BlockState state) {
        return state.getBlock() == BuildersAdditionsBlocks.ORANGE_DYE_BLOCK;
    }
}
