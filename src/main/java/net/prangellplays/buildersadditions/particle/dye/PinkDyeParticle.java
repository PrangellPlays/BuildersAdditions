...
public class PinkDyeParticle extends SpriteBillboardParticle {
    PinkDyeParticle(ClientWorld world, double x, double y, double z, Fluid fluid) {
        super(world, x, y, z);
    ...
    public static class LandingPinkDyeFactory
            implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public LandingPinkDyeFactory(SpriteProvider spriteProvider) {
    ...
    @Environment(value=EnvType.CLIENT)
    public static class FallingPinkDyeFactory implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public FallingPinkDyeFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }

        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ContinuousFalling blockLeakParticle = new ContinuousFalling(clientWorld, d, e, f, Fluids.EMPTY, BuildersAdditionsClient.LANDING_PINK_DYE);
    ...
    @Environment(value=EnvType.CLIENT)
    public static class DrippingPinkDyeFactory implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public DrippingPinkDyeFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }

        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            Dripping dripping = new Dripping(clientWorld, d, e, f, Fluids.EMPTY, BuildersAdditionsClient.FALLING_PINK_DYE);
    ...
    @Environment(value=EnvType.CLIENT)
    static class Dripping extends PinkDyeParticle {
    ...
    @Environment(value=EnvType.CLIENT)
    static class Falling extends PinkDyeParticle {
    ...
    @Environment(value=EnvType.CLIENT)
    static class Landing extends PinkDyeParticle {
