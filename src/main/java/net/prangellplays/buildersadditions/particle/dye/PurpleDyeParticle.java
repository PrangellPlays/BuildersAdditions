...
public class PurpleDyeParticle extends SpriteBillboardParticle {
    PurpleDyeParticle(ClientWorld world, double x, double y, double z, Fluid fluid) {
        super(world, x, y, z);
    ...
    public static class LandingPurpleDyeFactory
            implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public LandingPurpleDyeFactory(SpriteProvider spriteProvider) {
    ...
    @Environment(value=EnvType.CLIENT)
    public static class FallingPurpleDyeFactory implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public FallingPurpleDyeFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }

        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ContinuousFalling blockLeakParticle = new ContinuousFalling(clientWorld, d, e, f, Fluids.EMPTY, BuildersAdditionsClient.LANDING_PURPLE_DYE);
    ...
    @Environment(value=EnvType.CLIENT)
    public static class DrippingPurpleDyeFactory implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public DrippingPurpleDyeFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }

        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            Dripping dripping = new Dripping(clientWorld, d, e, f, Fluids.EMPTY, BuildersAdditionsClient.FALLING_PURPLE_DYE);
    ...
    @Environment(value=EnvType.CLIENT)
    static class Dripping extends PurpleDyeParticle {
    ...
    @Environment(value=EnvType.CLIENT)
    static class Falling extends PurpleDyeParticle {
    ...
    @Environment(value=EnvType.CLIENT)
    static class Landing extends PurpleDyeParticle {
