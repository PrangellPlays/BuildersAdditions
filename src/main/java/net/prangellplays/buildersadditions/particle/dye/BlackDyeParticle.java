...
public class BlackDyeParticle extends SpriteBillboardParticle {
    BlackDyeParticle(ClientWorld world, double x, double y, double z, Fluid fluid) {
        super(world, x, y, z);
    ...
    public static class LandingBlackDyeFactory
            implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public LandingBlackDyeFactory(SpriteProvider spriteProvider) {
    ...
    @Environment(value=EnvType.CLIENT)
    public static class FallingBlackDyeFactory implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public FallingBlackDyeFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }

        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ContinuousFalling blockLeakParticle = new ContinuousFalling(clientWorld, d, e, f, Fluids.EMPTY, BuildersAdditionsClient.LANDING_BLACK_DYE);
    ...
    @Environment(value=EnvType.CLIENT)
    public static class DrippingBlackDyeFactory implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public DrippingBlackDyeFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }

        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            Dripping dripping = new Dripping(clientWorld, d, e, f, Fluids.EMPTY, BuildersAdditionsClient.FALLING_BLACK_DYE);
    ...
    @Environment(value=EnvType.CLIENT)
    static class Dripping extends BlackDyeParticle {
    ...
    @Environment(value=EnvType.CLIENT)
    static class Falling extends BlackDyeParticle {
    ...
    @Environment(value=EnvType.CLIENT)
    static class Landing extends BlackDyeParticle {
