...
public class WhiteDyeParticle extends SpriteBillboardParticle {
    WhiteDyeParticle(ClientWorld world, double x, double y, double z, Fluid fluid) {
        super(world, x, y, z);
    ...
    public static class LandingWhiteDyeFactory
            implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public LandingWhiteDyeFactory(SpriteProvider spriteProvider) {
    ...
    @Environment(value=EnvType.CLIENT)
    public static class FallingWhiteDyeFactory implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public FallingWhiteDyeFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }

        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ContinuousFalling blockLeakParticle = new ContinuousFalling(clientWorld, d, e, f, Fluids.EMPTY, BuildersAdditionsClient.LANDING_WHITE_DYE);
    ...
    @Environment(value=EnvType.CLIENT)
    public static class DrippingWhiteDyeFactory implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public DrippingWhiteDyeFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }

        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            Dripping dripping = new Dripping(clientWorld, d, e, f, Fluids.EMPTY, BuildersAdditionsClient.FALLING_WHITE_DYE);
    ...
    @Environment(value=EnvType.CLIENT)
    static class Dripping extends WhiteDyeParticle {
    ...
    @Environment(value=EnvType.CLIENT)
    static class Falling extends WhiteDyeParticle {
    ...
    @Environment(value=EnvType.CLIENT)
    static class Landing extends WhiteDyeParticle {
