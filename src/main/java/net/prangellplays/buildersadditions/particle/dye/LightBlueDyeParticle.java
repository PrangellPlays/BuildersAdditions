...
public class LightBlueDyeParticle extends SpriteBillboardParticle {
    LightBlueDyeParticle(ClientWorld world, double x, double y, double z, Fluid fluid) {
        super(world, x, y, z);
    ...
    public static class LandingLightBlueDyeFactory
            implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public LandingLightBlueDyeFactory(SpriteProvider spriteProvider) {
    ...
    @Environment(value=EnvType.CLIENT)
    public static class FallingLightBlueDyeFactory implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public FallingLightBlueDyeFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }

        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            ContinuousFalling blockLeakParticle = new ContinuousFalling(clientWorld, d, e, f, Fluids.EMPTY, BuildersAdditionsClient.LANDING_LIGHT_BLUE_DYE);
    ...
    @Environment(value=EnvType.CLIENT)
    public static class DrippingLightBlueDyeFactory implements ParticleFactory<DefaultParticleType> {
        protected final SpriteProvider spriteProvider;

        public DrippingLightBlueDyeFactory(SpriteProvider spriteProvider) {
            this.spriteProvider = spriteProvider;
        }

        @Override
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            Dripping dripping = new Dripping(clientWorld, d, e, f, Fluids.EMPTY, BuildersAdditionsClient.FALLING_LIGHT_BLUE_DYE);
    ...
    @Environment(value=EnvType.CLIENT)
    static class Dripping extends LightBlueDyeParticle {
    ...
    @Environment(value=EnvType.CLIENT)
    static class Falling extends LightBlueDyeParticle {
    ...
    @Environment(value=EnvType.CLIENT)
    static class Landing extends LightBlueDyeParticle {
